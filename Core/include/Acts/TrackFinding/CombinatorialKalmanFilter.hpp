...
struct CombinatorialKalmanFilterOptions {
  ...
  /// Delegate definition to extend a trajectory onto the given surface.
  ///
  ...
  /// @return indidces of new track states which extend the trajectory given by prevTip
  ...
  using TrajectoryExtender =
      Delegate<Result<CkfTypes::BranchVector<TrackIndexType>>(
          ...
          const BoundState& boundState, TrackIndexType prevTip,
...
class CombinatorialKalmanFilter {
   ...
   public:
    ...
    using TrajectoryExtender =
        typename CombinatorialKalmanFilterOptions<
            track_container_t>::TrajectoryExtender;
 ...
 public:
  ...
  auto findTracks(const start_parameters_t& initialParameters,
    ...
    combKalmanActor.extendOrBranchTrajectory =
        tfOptions.extendOrBranchTrajectory;

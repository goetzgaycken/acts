...
BOOST_AUTO_TEST_CASE(ProtoDetectorTest) {
   ...
   //   vol_beam_pipe.container.Acts::ProtoVolume::ContainerStructure{};
   vol_beam_pipe.internal = Acts::ProtoVolume::InternalStructure{};
   vol_beam_pipe.internal.value().layerType = Acts::Surface::SurfaceType::Cylinder;
   ...
   //   vol_pixel_inner_ecn.container = Acts::ProtoVolume::ContainerStructure{};
   vol_pixel_inner_ecn.internal = Acts::ProtoVolume::InternalStructure{};
   vol_pixel_inner_ecn.internal.value().layerType = Acts::Surface::SurfaceType::Disc;
   ...
   vol_pixel_inner_barrel.internal = Acts::ProtoVolume::InternalStructure{};
   //   vol_pixel_inner_barrel.container = Acts::ProtoVolume::ContainerStructure{};
   vol_pixel_inner_barrel.internal.value().layerType = Acts::Surface::SurfaceType::Cylinder;
   ...
   vol_pixel_inner_ecp.internal = Acts::ProtoVolume::InternalStructure{};
   //   vol_pixel_inner_ecp.container = Acts::ProtoVolume::ContainerStructure{};
   vol_pixel_inner_ecp.internal.value().layerType = Acts::Surface::SurfaceType::Disc;
   ...
   vol_inner_pixel.container = Acts::ProtoVolume::ContainerStructure{};
   vol_inner_pixel.container.value().constituentBinning = {
      Acts::BinningData(Acts::open,
                        Acts::binZ,
                        {0., 1.})};
   vol_inner_pixel.container.value().constituentVolumes.reserve(3);
   vol_inner_pixel.container.value().constituentVolumes.push_back( std::move( vol_pixel_inner_ecn) );
   vol_inner_pixel.container.value().constituentVolumes.push_back( std::move( vol_pixel_inner_barrel) );
   vol_inner_pixel.container.value().constituentVolumes.push_back( std::move( vol_pixel_inner_ecp) );
   ...
   vol.container = Acts::ProtoVolume::ContainerStructure{};
   vol.container.value().constituentBinning = {
      Acts::BinningData(Acts::open,
                        Acts::binR,
                        {0., 1.})};
   vol.extent.set(Acts::binZ,-3001., 3001.);
   vol.container.value().constituentVolumes.reserve(2);
   vol.container.value().constituentVolumes.push_back( std::move( vol_beam_pipe) );
   vol.container.value().constituentVolumes.push_back( std::move( vol_inner_pixel) );
